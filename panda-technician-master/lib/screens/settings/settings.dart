...
void initState() {
 ...
 bool stateNow =  Provider.of<StateProvider>(context,listen: true).active;
    ...
    return Scaffold(
     ...
     appBar: AppBar(
       centerTitle: true,
       foregroundColor: Colors.black, title: const Text("Settings",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold, color: Colors.black)), backgroundColor: Colors.white,),
      body: Container(
        ...
        child: Column(
          children: <Widget>[
              ...
              Container(
                ...
                child: Text("Welcome to the settings Screen.", textAlign: TextAlign.center,
                 style: TextStyle(
  ...
  SingleTag(ico: Icons.email, title: "Update Email", callBackHandler: (()async{
                   var response =  await ApiHandler().sendOtp(profile.id, context);
                   if(response){

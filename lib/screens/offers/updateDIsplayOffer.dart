...
class UpdateDisplayOffer extends StatelessWidget {
  UpdateDisplayOffer({super.key});
  ...
  double getTotal() {
    ...
    for (int x = 0; x < detailedOffer.offer.items.length; x++) {
      total = total +
          (detailedOffer.offer.items[x].price == ""
              ? 0
              : double.parse(detailedOffer.offer.items[x].price));
// total = total + detailedOffer.offer[x].price;
    }
//  total = ((total)+ ((detailedOffer.offer.vat * total)/100));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Estimations", style: TextStyle(color: Colors.black)),
                                            ...
                                            Text("Tax: ",
                                                style: TextStyle(
                                                    ...
                                                    fontWeight:
                                                        FontWeight.bold)),
                                            Text(
                                                "\$${((detailedOffer.offer.vat * getTotal()) / 100).roundToDouble()}",
                                                style: TextStyle(
                                                    fontSize: 16,
                                                    fontWeight:
                                                        FontWeight.normal)),
                                            ...
                                            Text("Total: ",
                                                style: TextStyle(
                                                    ...
                                                    fontWeight:
                                                        FontWeight.bold)),
                                            Text(
                                                "\$${(getTotal() + ((detailedOffer.offer.vat * getTotal()) / 100)).toStringAsFixed(2)}",
                                                style: TextStyle(
                                                    fontSize: 16,
                                                    fontWeight:
                                                        FontWeight.normal)),
...
// Text("Title: " + detailedOffer.offer.items[index].title),
        ...
        CustomButton(
            buttonTitle: "Update Offer",
            callBackFunction: (() {
              // detailedOffer.offer.totalEstimation = (double.parse(detailedOffer.offer.totalEstimation )+ ((detailedOffer.offer.vat * double.parse(detailedOffer.offer.totalEstimation))/100)).roundToDouble().toString();

              ApiHandler().updateOffer(
                  detailedOffer.offer, context, detailedOffer.detailedRequest);
            })),
        SizedBox(
          height: 30,
        )

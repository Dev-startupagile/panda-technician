...
class JobList extends StatelessWidget { // Wrapper Widget
    @override
      ...
      showDialog(
          ...
          child: Row(children: <Widget>[
              ...
              child: Column(children: <Widget>[
                  const Text("Mobile Technician", style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
        ...
        Container(
         ...
         onPressed: () {
          ...
          child:const Text('Cancel', style: TextStyle(fontSize: 14,color: Colors.white), textAlign: TextAlign.center,),
              ...
              decoration:  BoxDecoration(borderRadius: BorderRadius.circular(10), color:const Color.fromARGB(255, 92, 86, 86)),
              margin:const EdgeInsets.fromLTRB(0, 10, 0, 0),  
              child:TextButton(

                
         onPressed: () {
                Navigator.pushNamed(context, "JobDetail",arguments: new RequestsModel(id: 1) );

          },
          child:const Text('Accept', style: TextStyle(fontSize: 14,color: Colors.white), textAlign: TextAlign.center,),
)  
  ...
  getSpecificJobs(context,List<StatusRequest> statusRequest,List<int> canceld,Function callBack){
     return showDialog(
                context: context,
                builder: (BuildContext context) {
                   return Container(
            ...
            itemBuilder: (
            context,index){
               return (statusRequest[index].requestStatus == "PENDING" && !canceld.contains(index)) ? SpecificSingleOfferCard(time: statusRequest[index].schedule.time , date: statusRequest[index].schedule.date,requestId: statusRequest[index].id,request: statusRequest[index],cancelOffer: ((){
                callBack();
  ...
  void _showJobList(context){
    ...
    MaterialPageRoute(builder: (context) => const MapScreen()),
         ...
         onPressed: () {
                     Navigator.pushNamed(context, "JobDetail",arguments: new RequestsModel(id: 0) );

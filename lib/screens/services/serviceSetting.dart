                    ...
                    children: <Widget>[
                      Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                                "Select the services you offer and set the rate for each one. You can toggle them on and off at anytime.",
                      ...
                      Container(
                          ...
                          child: const Image(
                              image: AssetImage("assets/transparentCar.png"))),
                      Container(
                          alignment: Alignment.center,
                          height: 20,
                          width: double.infinity,
                      ...
                      Container(
                          ...
                          width: double.infinity,
                          child: Text(
                            "Mobile diagnostic and repair services.",
                            style: TextStyle(
                      ...
                      FeeTag(
                          ...
                          hintTexts: profile.diagnosticFee.toString(),
                      ...
                      FeeTag(
                          title: "Hourly Fee",
                          hintTexts: profile.hourlyFee.toString(),
                          callBackHandler: ((value) {
                            setState(() {

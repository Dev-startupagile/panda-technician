...
class SingleOfferCard extends StatelessWidget {
   SingleOfferCard({super.key, required this.time, required this.date, required this.requestId, required this.request, required this.cancelOffer});
    String time;
    String date;
    String requestId;
    RequestsM request;
            ...
            children: <Widget>[
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(request.description.title, style: TextStyle(fontSize: 14, color: Colors.grey[400])),
              ...
              child: Column(children: <Widget>[
                  Text(changeToAmPm(time), style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
                  Text(getUsDateFormat(date), style: TextStyle(fontSize: 14, color: Colors.grey[400])),
        ...
        Container(
         ...
         onPressed: () {
           ...
           DialogBox(context, "Message", "Are you sure you want to cancel this Offer?", "No", "Yes", ((){
             ...
             //if yes
                            ApiHandler().rejectJob(request.id,"notRequired",request.customerId,context);
         ...
         onPressed: () {
           ApiHandler().jobDetailed(requestId, context,request);
